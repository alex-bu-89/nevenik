    				...
    				<div class="container">
    					<div class="row">
    							...
    							<ul>
    								...
    								<li>Заказ обходится нашим клиентам недорого: в среднем на 10-13% дешевле за счет бесплатной доставки*, чем у серьезных конкурентов (дешевые продавцы некондиции нaм не конкуренты, мы равняется на самые высокие стандарты!).</li>
    								<li>Доставка по Санкт-Петербургу – бесплатно!</li>
    							</ul>
    							<p><i>* При заказе от 2000 тысяч рублей.</i></p>
    					</div>
    				</div>
    		</section>
