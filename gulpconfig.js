...
// Project paths
var project     = 'kupinevenik',          // The directory name for your theme; change this at the very least!
...
module.exports = {
  ...
  browsersync: {
    ...
    proxy: 'localhost:8888/kupinevenik.dev/', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
